...
| :--- | :--- | :--- |
| Actualiza conceptos y conocimientos necesarios para su desarrollo profesional y en especial para su proyecto en soluciones de software. | **Cacho Seminario, Diego Alonso**<br>TB1: Para la primera entrega del trabajo (TB1) me enfoque en realizar los puntos de Empathy Maps, As-Is Scenario Mapping y el To-Be Scenario Mapping además de organizar parte del reporte, presentación y documento de participación. <br>TP:<br>TB2:<br>TF:<br><br>**Julca Minaya, Sergio Gino**<br>TB1:<br>TP:<br>TB2:<br>TF:<br><br>**Urrutia Pena, Jasmin Adriana**<br>TB1:<br>TP:<br>TB2:<br>TF:<br><br>**Vega Coronado, Fabricio Samir**<br>TB1:<br>TP:<br>TB2:<br>TF:<br><br>**Villanueva Andrade, Ysaac Ligorio**<br>TB1:<br>TP:<br>TB2:<br>TF: |  |
| Reconoce la necesidad del aprendizaje permanente para el desempeño profesional y el desarrollo de proyectos en soluciones de software. | **Cacho Seminario, Diego Alonso**<br>TB1: En la primera entrega utilice herramientas como GitHub, UXPressia, Canva y Google Docs, estas aplicaciones me permitieron brindarle apoyo al trabajo junto a mis compañeros por medio de mi aprote como miembro de grupo. <br>TP:<br>TB2:<br>TF:<br><br>**Julca Minaya, Sergio Gino**<br>TB1:<br>TP:<br>TB2:<br>TF:<br><br>**Urrutia Pena, Jasmin Adriana**<br>TB1:<br>TP:<br>TB2:<br>TF:<br><br>**Vega Coronado, Fabricio Samir**<br>TB1:<br>TP:<br>TB2:<br>TF:<br><br>**Villanueva Andrade, Ysaac Ligorio**<br>TB1:<br>TP:<br>TB2:<br>TF: |  |
...
#### 3.2 User Stories
### 1.1.2 Matriz de User Stories y Epics - Foodly
